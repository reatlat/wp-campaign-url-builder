...
<div class="wrap <?php echo get_locale(); ?>" id="reatlat_cub">
    ...
    <h1><span class="dashicons dashicons-share-alt"></span> <?php _e('Campaign URL Builder', 'campaign-url-builder'); ?> <i class="reatlat_cub_by">by <a href="https://reatlat.net/?utm_source=wp_plugin&utm_medium=title_header&utm_campaign=<?php echo esc_attr( $plugin->plugin_real_name ); ?>" target="_blank">Alex Zappa</a></i> </h1>
	...
	<ul class="reatlat_cub_tabs">
        ...
        <?php if ( current_user_can('administrator') || ! get_option( $plugin->plugin_name . '_admin_only' ) ) : ?>
        <li><a href="#reatlat_cub_tab-3"><span class="dashicons dashicons-warning"></span> <?php _e('Advanced', 'campaign-url-builder'); ?></a></li>
        <?php endif; ?>
        <li><a href="#reatlat_cub_tab-4"><span class="dashicons dashicons-editor-code"></span> <?php _e('Shortcode', 'campaign-url-builder'); ?></a></li>
